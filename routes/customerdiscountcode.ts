...
import { createCustomerDiscountCodeSchema, getBydiscountCodeAndSuppIdBodySchema, getByStatusQuerySchema, reduceDiscountCodeBodySchema } from "../services/validation/customerdiscountcode";
...
router.post(
  '/customerDiscountCodeAndSuppId',
  authentication.protected,
  authentication.checkRole(["Customer"]),
  validator.body(getBydiscountCodeAndSuppIdBodySchema),
  customerDiscountCode.getCustomerDiscountByDiscountCodeAndSuppId
)
